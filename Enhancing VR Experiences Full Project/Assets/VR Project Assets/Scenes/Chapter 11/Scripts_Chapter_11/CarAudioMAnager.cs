...
{
    public AudioSource engineAudioSource;   // The AudioSource for the engine sound
    public AudioSource honkAudioSource;     // The AudioSource for the honk sound
    public AudioClip engineSound;           // The audio clip for the engine sound
    public AudioClip honkSound;             // The audio clip for the honk sound
    public float minHonkInterval = 10f;      // The minimum time between honks (in seconds)
    public float maxHonkInterval = 120f;     // The maximum time between honks (in seconds)
    public float honkCooldown = 120f;        // The cooldown period between honks (in seconds)
  public float honkTimer = 0f;            // Timer for tracking time until next honk
    private float cooldownTimer = 0f;        // Timer for tracking cooldown period after honk
